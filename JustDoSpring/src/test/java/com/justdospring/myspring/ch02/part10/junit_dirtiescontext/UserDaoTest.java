...
@ContextConfiguration(locations="/applicationContext9.xml")
@DirtiesContext
public class UserDaoTest {
	...
	@Before
	public void setUp() {
		DataSource dataSource = new SingleConnectionDataSource("jdbc:postgresql://localhost:5455/postgres", "postgres", "gre1234", true);
